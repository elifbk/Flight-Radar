...
import c from "../utils/checkValid"; // checkValid

const Modal = ({ detailId, close }) => {
  // not: uçuş detay verisini sadece modal bileşeni içerisinde kullanacağımız için store'da saklama ihtiyacı duymadık
